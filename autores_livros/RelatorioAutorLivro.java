...
public class RelatorioAutorLivro extends RelatorioBase{
	
	public boolean gerarRelatorio(List<Livro> lista2, String autor) {

		try {
			JasperReport jr	= null;
			Map<String, Object> parametros = null;
																
			InputStream inputStream = getClass().getResourceAsStream("/capitulo_25_bd/projeto_I/relatorios/rel_livros_autor.jrxml");     
			...
			boolean retorno =  this.criaRelatorios("RELATÓRIO LIVROS POR AUTOR", jr, parametros, ds);
