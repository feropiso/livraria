...
public class RelatorioEstoque extends RelatorioBase {
	...
	public boolean gerarRelatorio() {
		...
		try {
			...
			InputStream inputStream = getClass().getResourceAsStream("/capitulo_25_bd/projeto_I/relatorios/rel_estoque.jrxml");     
			...
			List<ItemEstoque> lista = daoestoque.listaEspecial();
			...
			boolean retorno =  this.criaRelatorios("RELATÓRIO GERAL DE ESTOQUE", jr, parametros, ds);
