...
public class RelatorioItensVenda extends RelatorioBase {
	...
	public boolean gerarRelatorio() {
		...
		try {
			...
			InputStream inputStream = getClass().getResourceAsStream("/capitulo_25_bd/projeto_I/relatorios/rel_itens_venda.jrxml");     
			...
			List<ItensVenda> lista = daoitensvenda.listaEspecial();
			...
			boolean retorno =  this.criaRelatorios("RELATÓRIO GERAL DE ITENS-VENDA", jr, parametros, ds);
